...
@Service
public class HandleWrapupCode {
	
	@Autowired
	OrgConfigService orgConfigService;
	
	@Autowired
	WrapUpCodeServices wrapUpCodeService;
	...
	public String handleDeleteWrapUpCodeFile(MultipartFile file, HttpSession session, Model model,
